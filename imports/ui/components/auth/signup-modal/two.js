          ...
          <div className="create-account">
            ...
            <div className="f-form-group f-error">
              ...
              <div className="f-input-icon f-input-icon-email">
                ...
                <input id="signup-email-address" type="email" autoFocus name="email" placeholder="jamie@example.com" autoCorrect="off" value="" className="f-input" />
              </div>
              <p className="f-response">Please supply an email</p>
            </div>
            ...
            <div className="f-form-group ">
              ...
              <div className="f-input-icon f-input-icon-user-circle">
                ...
                <input id="signup-name" type="text" name="name" placeholder="Jamie Larson" autoCorrect="off" value="" className="f-input" />
              </div>
              <p className="f-response">Please enter a name</p>
            </div>
            ...
            <div className="f-form-group f-success">
              ...
              <p className="f-response">Cool. That should work</p></div>
          </div>
        </div>
      </div>
    );
